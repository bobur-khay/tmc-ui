...
// __SERVER_AVAILABLE__ is true with both SERVER_URL and
// TOKEN_URL configured. App.tsx computes authConfigured = true, so it gates
...
beforeEach(() => {
  ...
  vi.stubEnv('TOKEN_URL', TOKEN_URL);
