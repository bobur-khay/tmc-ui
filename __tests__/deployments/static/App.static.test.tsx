...
// __API_BASE__ and __SERVER_AVAILABLE__. These tests render the real App tree and
...
beforeEach(() => {
  ...
  vi.stubEnv('EDITDOR_URL', '');
  vi.stubEnv('PLAYGROUND_URL', '');
...
describe('Static deployment integration tests', () => {
  test('Landing page navigation, filters, and results no items', async () => {
    ...
    vi.stubEnv('EDITDOR_URL', 'https://eclipse-editor.github.io/editor/');
    vi.stubEnv('PLAYGROUND_URL', 'https://playground.thingweb.io/');
    vi.stubEnv('TOKEN_URL', 'https://tmcprod.eu1.sws.siemens.com/oauth/token');
    vi.stubEnv('SERVER_URL', 'https://eu1.thingmodels.siemens.cloud');
    vi.stubEnv('CREDENTIALS_SETUP_MESSAGE', '');
